...
Mock.mock(/^\/api\/blog(\?.+)?$/,"get",function (options) {
    const temp = qs.parse(options.url);
    return Mock.mock({
        "code": 0,
	    "msg": "",
        "data":{
...
Mock.mock('/api/comment',"post",function (options) {
  const temp = JSON.parse(options.body).message
  console.log(temp.nickname, temp.content)
  return Mock.mock({
    "code": 0,
    "msg": "",
    "data": {
          ...
          createDate:Date.now(),
          "avatar|1":[
              "hthttps://pic4.zhimg.com/80/v2-7c8ea469bbe025cde1863413dcedc7c6_720w.jpg?source=1940ef5ctps://pic4.zhimg.com/da8e974dc_is.jpg",
              "https://pic2.zhimg.com/80/v2-b84705eaee1eb4afa3b0cf8b1760a92c_720w.jpg?source=1940ef5c",
              "https://pic1.zhimg.com/80/v2-e2985cdb4055b68e5dc919c42a630ec5_720w.jpg?source=1940ef5c",
              "https://pic1.zhimg.com/80/v2-5f739a2c918a1cface3864cd55e160a9_720w.jpg?source=1940ef5c",
